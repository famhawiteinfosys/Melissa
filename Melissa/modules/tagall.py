...
TAGMES = [ " **sab kehate hain raat gayi baat gayi lekin ye baat jaati kahaan hai 🤔** ",
           " **इज़्ज़त किया करो,बेइज़्ज़ती तो हमारे घर वाले ही बहुत करते हैं 🥺** ",
           " **doctor ne khoon ki kami batayi hai kiska khoon piyun… 😆** ",
           " **kisi aur se dhokha khaane se acha hai Mere saath chalo momos aur Golgappe khayeinge 🤤** ",
           " **तुम बहुत अच्छे हो 💞, तुमने मुझे मेरी पिकअप लाइन भुला दी 😅** ",
           " **तुम्हारी आँखें 👀 सागर 🌊 के रंग की हैं, और मुझे उनमें खो जाना अच्छा लगता है। ☺️** ",
           ...
           " **zinda hai ya chal basa 🤔** ",
           " **bhai VC aaja setting chal rahi hai 🤭** ",
           " **aaja bhai teri setting kara dun 😝** ",
           " **holla kaha ho ji ap 🥹🥹** ",
...
ENGES = [  " ** I hope you know CPR, because you just took my breath away! 😜** ",
