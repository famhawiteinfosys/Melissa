...
# from Melissa.modules.sql import warns_sql as warnssql
import Melissa.modules.sql.blacklist_sql as blacklistsql

# from Melissa.modules.sql import cust_filters_sql as filtersql
# import Melissa.modules.sql.welcome_sql as welcsql
import Melissa.modules.sql.locks_sql as locksql
import Melissa.modules.sql.notes_sql as sql

# from Melissa.modules.rules import get_rules
import Melissa.modules.sql.rules_sql as rulessql
from Melissa import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Melissa.__main__ import DATA_IMPORT
from Melissa.modules.connection import connected
from Melissa.modules.helper_funcs.alternate import typing_action
from Melissa.modules.helper_funcs.chat_status import user_admin
from Melissa.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Melissa{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Melissa{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Melissa-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Melissa{}.backup".format(chat_id))  # Cleaning file
