...
import Melissa.modules.sql.global_bans_sql as sql
from Melissa import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Melissa.modules.helper_funcs.misc import send_to_list
from Melissa.modules.sql.users_sql import get_user_com_chats
