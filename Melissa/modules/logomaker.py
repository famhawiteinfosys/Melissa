...
from Melissa import OWNER_ID, BOT_USERNAME, BOT_NAME
from Melissa import telethn as tbot
from PIL import Image, ImageDraw, ImageFont
from telethon.tl.types import InputMessagesFilterPhotos
from io import BytesIO
from requests import get
from Melissa import SUPPORT_CHAT
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./Melissa/IROFont/logofonts/*")
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./Melissa/IROFont/blackbg.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "black"
